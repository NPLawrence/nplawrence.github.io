...
"""Generates LaTeX and Markdown copies of my cv."""
...
def main():
    parser = argparse.ArgumentParser(description='Generates LaTeX and Markdown resumes from data in YAML files.')
    parser.add_argument('yamls', metavar='YAML_FILE', nargs='+',
                        help='The YAML files that contain the resume/cv details, in order of increasing precedence')
